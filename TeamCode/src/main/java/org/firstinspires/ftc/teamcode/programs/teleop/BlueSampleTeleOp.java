...
@TeleOp(name = "BlueSampleTeleOp", group = "OpModes")
public class BlueSampleTeleOp extends CommandOpMode {
    ...
    public void run() {
        ...
        robot.camera.setDetectionMode(Camera.Detection.BLUE_YELLOW);
